...
public class CommandSpawn_seller implements CommandExecutor {

	@Override
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		if (sender instanceof Player) {
            Player p = (Player) sender;
            String name = Config.villager[1];
            int counter = 0;
            ...
            if (p.isOp()) {
                ...
                ((CraftVillager)villager).getHandle().setProfession(3); //type
            	...
            	for(Entity e : Bukkit.getWorld(Config.getWorldName()).getEntities()) { //kill old buyer
            		if (e.getCustomName() != null) {
            			if (e.getCustomName().equals(name)) {
            				...
            				ConfigSettings.setVillagerSeller(p.getLocation());
            			}
            		}
            	}
